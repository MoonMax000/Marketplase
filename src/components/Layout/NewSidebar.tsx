    ...
    children: [
      {
        ...
        title: 'Portfolios',
        route: 'http://localhost:3002/portfolios',
      },
      {
        icon: <Calendar className="h-4 w-4" />,
        title: 'Calendar',
        route: 'http://localhost:3002/calendar',
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        title: 'Portfolios',
        route: 'http://localhost:3003/portfolios',
      },
    ],
  },
  {
    ...
    children: [
      { icon: <Users className="h-4 w-4" />, title: 'Feed', route: 'http://localhost:3001/feed' },
      {
    ...
    children: [
      {
        ...
        title: 'Following',
        route: 'http://localhost:3004/following',
      },
    ],
  },
  {
    ...
    children: [
      {
        icon: <Bot className="h-4 w-4" />,
        title: 'Profile',
        route: 'http://localhost:3006/profile',
      },
      {
        icon: <Bot className="h-4 w-4" />,
        title: 'Agents',
        route: 'http://localhost:3006/agents',
      },
    ],
  },
  {
